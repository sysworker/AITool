...
class DDGImageFilter: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        self.imageView.frame = CGRect(x: 20, y: 170, width:width - 40, height: width)
        ...
        for i  in 0 ..< titleArr.count {
            ...
            changeBtn.tag = 100 + i
            changeBtn.frame = CGRect(x: 20 + btnWidth * CGFloat(i % 4), y: width + 200 + 40 * CGFloat(i / 4), width: btnWidth  , height: 40 )
