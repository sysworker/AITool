...
class DDGScollViewShot: BaseViewController {
    ...
    func setUpUI() {
        ...
        testScrollView.frame = CGRect(x: 10, y: statusBarAndNavigationBarHeight+20, width: width - 20, height: height - statusBarAndNavigationBarHeight - 20 - 100)
        ...
        activity.frame = CGRect(x:width / 2.0 - 15, y: statusBarAndNavigationBarHeight - 20 - 10, width: 30, height: 30)
