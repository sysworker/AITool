...
class DDGSeniorImageFilter: BaseViewController {
    ...
    func setupSubviews(){
        ...
        self.imageView.frame = CGRect(x: 20, y: 170, width:screenWidth - 40, height: screenWidth)
        ...
        slider = UISlider()
        slider.frame = CGRect(x: 20, y: screenWidth + 180, width: screenWidth - 40, height: 20)
        ...
        for i  in 0 ..< titleArr.count  {
            ...
            changeBtn.frame = CGRect(x: 20 + btnWidth * CGFloat(i % 4), y: screenWidth + 200 + 40 * CGFloat(i / 4), width: btnWidth  , height: 40 )
